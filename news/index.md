...
- Fix
  ...
  to return the version as a string instead of simply printing it to
  allow programmatic checks for libdeflate presence.

- iscream now informs users whether they have libdeflate-enabled htslib
  on package load.
...
- Document how to make use of strand information with
  [`tabix()`](https://huishenlab.github.io/iscream/reference/tabix.md)
- Improve wording of
  [`tabix()`](https://huishenlab.github.io/iscream/reference/tabix.md)‘s’
