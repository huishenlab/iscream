...
100 human cell WGBS data from the snmC-seq2 [@luo2018a] dataset:
...
memory at the same time. For more information on multithreading and its
considerations see `?set_threads()`.
...
as it can stream to a file and for reading in R while the htslib API stores the
strings in memory and is slower. iscream will look for the tabix executable on
startup and will only fall back to the htslip API if the executable is not
...
across 100 took 11.605 seconds.
...
#> [13:49:49.681463] [iscream::summarize_regions] [info] Summarizing 5000 regions from 100 bedfiles
#> [13:49:49.681518] [iscream::summarize_regions] [info] using sum, mean, median, stddev, variance, min, max, range, count
#> [13:49:49.681520] [iscream::summarize_regions] [info] with columns 4 as beta
```
...
records across all 100 took 5.805 seconds. As with `tabix()`, runtime reduces
and memory usage increases with increasing thread counts.
...
qt <- system.time(meth_mat <- make_mat(
  bedfiles,
  regions,
  column = 4,
  sparse = TRUE,
...
#> [13:49:58.058188] [iscream::query_all] [info] Querying 5000 regions from 100 bedfiles
#> 
#> [13:50:44.309482] [iscream::query_all] [info] Creating metadata vectors
#> [13:50:44.614563] [iscream::query_all] [info] 7276107 loci found - 16250 extra rows allocated with 0 resizes
#> [13:50:48.254557] [iscream::query_all] [info] Creating sparse matrix
```
...
#> [1] iscream_0.99.0    data.table_1.17.8
#> 
#> loaded via a namespace (and not attached):
#>  [1] crayon_1.5.3                knitr_1.47                 
#>  [3] xfun_0.52                   generics_0.1.4             
#>  [5] DelayedArray_0.35.2         RcppParallel_5.1.10        
#>  [7] S4Vectors_0.47.0            SummarizedExperiment_1.39.1
#>  [9] stringfish_0.16.0           stats4_4.5.1               
#> [11] MatrixGenerics_1.21.0       Biobase_2.69.0             
#> [13] grid_4.5.1                  Seqinfo_0.99.1             
#> [15] evaluate_0.24.0             abind_1.4-8                
#> [17] IRanges_2.43.0              compiler_4.5.1             
#> [19] Rcpp_1.1.0                  XVector_0.49.0             
#> [21] lattice_0.22-7              SparseArray_1.9.0          
#> [23] parallelly_1.45.0           parallel_4.5.1             
#> [25] GenomicRanges_1.61.1        Matrix_1.7-3               
#> [27] tools_4.5.1                 matrixStats_1.5.0          
#> [29] S4Arrays_1.9.1              BiocGenerics_0.55.0
```
