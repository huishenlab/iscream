...
Time to make the query and compute the summary: 2.426s elapsed (5.055s cpu).
...
calculating the summaries and plotting: 2.470s elapsed (5.096s cpu). With methscan,
...
## [1] ggplot2_3.5.1      data.table_1.16.4  iscream_0.0.0.9000
## 
...
## [21] Rcpp_1.0.13-1      pkgconfig_2.0.3    farver_2.1.2       lattice_0.22-6    
## [25] R6_2.5.1           tidyselect_1.2.1   pillar_1.10.0      parallelly_1.41.0 
## [29] parallel_4.4.2     magrittr_2.0.3     Matrix_1.7-1       withr_3.0.0       
## [33] tools_4.4.2        gtable_0.3.5
```
