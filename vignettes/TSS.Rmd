...
Time to make the query and compute the summary: 6.818s elapsed (4.979s cpu).
...
calculating the summaries and plotting: 6.859s elapsed (5.020s cpu). With methscan,
