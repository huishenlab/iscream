...
``` r
full_summary <- summarize_regions(bedfiles[1:8], regions)
#> [10:10:12.814740] [iscream::summarize_regions] [info] Summarizing 20048 regions from 8 bedfiles
#> [10:10:12.814782] [iscream::summarize_regions] [info] using sum, mean, median, stddev, variance, min, max, range, cpg_count
```
