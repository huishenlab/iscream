...
- [`make_mat_bsseq()`](https://huishenlab.github.io/iscream/reference/make_mat_bsseq.md)
...
- [`get_granges_string()`](https://huishenlab.github.io/iscream/reference/get_granges_string.md)
  : GRanges to region strings
- [`get_df_string()`](https://huishenlab.github.io/iscream/reference/get_df_string.md)
  : DataFrame to region strings

### Multithreading

- [`get_threads()`](https://huishenlab.github.io/iscream/reference/get_threads.md)
...
- [`set_log_level()`](https://huishenlab.github.io/iscream/reference/set_log_level.md)
  [`get_log_level()`](https://huishenlab.github.io/iscream/reference/set_log_level.md)
  : Set and get logging level

### htslib

- [`htslib_version()`](https://huishenlab.github.io/iscream/reference/htslib_version.md)
