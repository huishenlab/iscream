...
#' @keywords internal
#' @export
Cpp_query_all_dense <- function(bedfiles, regions, bismark, merged, sparse, nthreads) {
    .Call(`_iscream_Cpp_query_all_dense`, bedfiles, regions, bismark, merged, sparse, nthreads)
}
...
#'
#' @export
Cpp_query_all_sparse <- function(bedfiles, regions, bismark, merged, sparse, nthreads) {
    .Call(`_iscream_Cpp_query_all_sparse`, bedfiles, regions, bismark, merged, sparse, nthreads)
}
...
#'
#' @export
Cpp_query_all_reference <- function(bedfiles, regions, mmat, cmat, bismark, merged, sparse, nthreads) {
    invisible(.Call(`_iscream_Cpp_query_all_reference`, bedfiles, regions, mmat, cmat, bismark, merged, sparse, nthreads))
}
